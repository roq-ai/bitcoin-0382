...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'deposit.update': {
    roles: ['account-owner', 'team-member'],
    key: 'deposit-update',
    tenantPath: ['organization', 'user', 'deposit'],
    userPath: [],
  },
  'profit.update': {
    roles: ['account-owner', 'team-member'],
    key: 'profit-update',
    tenantPath: ['organization', 'user', 'deposit', 'profit'],
    userPath: [],
  },
  'user.delete': {
    roles: ['account-owner', 'team-member'],
    key: 'team-member-removal',
    tenantPath: ['organization', 'user'],
    userPath: [],
  },
};

const ownerRoles: string[] = ['financial-manager'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['account-owner', 'team-member', 'financial-manager'];

...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['financial-manager', 'account-owner', 'team-member'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Deposits', path: '/deposits', entity: 'deposit', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'Minings', path: '/minings', entity: 'mining', service: AccessServiceEnum.PROJECT, icon: FiHardDrive },
    { name: 'Profiles', path: '/profiles', entity: 'profile', service: AccessServiceEnum.PROJECT, icon: FiInfo },
    { name: 'Profits', path: '/profits', entity: 'profit', service: AccessServiceEnum.PROJECT, icon: FiTrendingUp },

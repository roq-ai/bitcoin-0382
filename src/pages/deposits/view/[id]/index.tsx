...
import { getDepositById } from 'apiSdk/deposits';
...
function DepositViewPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<DepositInterface>(
    () => (id ? `/deposits/${id}` : null),
    () =>
      getDepositById(id, {
        relations: ['user'],
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('deposit', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/deposits/edit/${id}`} passHref legacyBehavior>
                    <Button

...
import { MiningListPage } from 'pages/minings';
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Percentage Gain" text={data?.percentage_gain} />
                ...
                {hasAccess('deposit', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Deposit"
                    text={
                      <Link as={NextLink} href={`/deposits/view/${data?.deposit?.id}`}>
